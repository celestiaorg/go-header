...
// sendMessage opens the stream to the given peers and sends HeaderRequest to fetch ExtendedHeaders.
// As a result sendMessage returns HeaderResponse, the size of fetched data,
